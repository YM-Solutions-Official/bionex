  ...
  return (
    <footer className="w-full border-t border-slate-200 bg-white text-slate-800 font-sans">
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:py-14">
        <div className="grid gap-10 md:grid-cols-3 lg:grid-cols-4 lg:gap-12">
          {/* Brand */}
      ...
      <div className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-4 text-sm text-slate-500 sm:flex-row sm:px-6">
          <p className="text-center sm:text-left">
            © {year} BioNex Systems. All rights reserved.
          </p>
          <div className="flex flex-wrap items-center gap-3">
            <Link to="/service" className="transition-colors hover:text-emerald-600">
              Terms of service
            </Link>
